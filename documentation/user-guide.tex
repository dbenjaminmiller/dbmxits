...
DBMXITS is Times-like font for scientific publishing with support for mathematical
...
fields of science. DBMXITS supports also proper mathematical typesetting and can
...
DBMXITS is available as an OpenType font, in four styles; regular, bold, italic
and bold italics, besides the maths font.

\section{Font features}

DBMXITS supports the following OpenType features:
...
Recent versions of \CONTEXT\ already have typescripts for DBMXITS, so just
...
is needed for using DBMXITS fonts in math mode.
